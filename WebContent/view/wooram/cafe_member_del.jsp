	...
	<div id="wrap">
		...
		<div class="base_wrap">
			<div id="container" align="center">
				...
				<!-- 여기까지  -->
				<div id="in_con">
					<form method="post" action="cafe_member_del_ok.jsp" name="forms">
						<input type="hidden" name="cmno" value="<%=cmno%>" /> <input
							type="hidden" name="mtype" value="${cdto.mtype }" />
						<table align="center">
							<c:if test="${cdto.mtype == 'n' }">
								<tr align="center">
									<td><input type="text" name="nick" maxlength="10"
										value="<%=dao.getDto().getNick()%>"
										style="border: 0px; text-align: center; font-weight: bold;"
										readonly="readonly">회원님 정말 탈퇴 하시겠습니까?</td>
								</tr>
								<tr align="center">
									<td>탈퇴하시더라도 작성하신 글과 댓글은 삭제되지 않습니다.</td>
								</tr>
								<tr align="center">
									<td><input type="submit" value="탈퇴하기"> <input
