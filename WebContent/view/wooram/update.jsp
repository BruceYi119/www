...
<link rel="stylesheet" href="/view/css/cafe_update.css">
<%=js%>
...
<body>
	...
	<input type="hidden" name="animalv"
		value="<%=dao.getDto().getAnimal()%>" />
	<input type="hidden" name="writypev"
		value="<%=dao.getDto().getWritype()%>" />
						...
						<table align="center">
							...
							<tr>
								...
								<td><input type="text" name="name"
									value="<%=dao.getDto().getName()%>" readonly="readonly"
									style="border: 0px;"></td>
							</tr>
							<%
							...
							<tr>
								<td>사진</td>
								<td><input type="file" name="fname"> <img
									src="/filepath/<%=dao.getDto().getFname()%>" width="250"
									height="150" /></td>
							</tr>
							<tr>
								<td>내용</td>
							...
							<tr align="center">
								<td colspan="2"><input type="submit" value="수정하기" /> <input
									...
									onclick="location.href='content.jsp?cno=<%=cno%>'"></td>
						</table>
					</form>
				</div>
			</div>
