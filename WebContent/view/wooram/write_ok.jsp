...
String sql = "insert into cafe(cno,writype,animal,title,name,pwd,content,fname,fimsi)";
sql= sql+" values(s_cafe.nextval,?,?,?,?,?,?,?,?)";

CafeDAO dao = new CafeDAO();

int r = dao.insert(sql, writype,animal,title,name,pwd,content,fname,fimsi);
