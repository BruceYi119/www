...
<%=js%>
<script defer src="/view/js/cafe_write.js"></script>
			...
			<div id="container" align="center">
				...
				<div id="in_con">
					<form method="post" action="write_ok.jsp"
						onsubmit="return formCheck(this);" name="forms"
						...
						<table align="center">
							...
							<tr>
								<td>작성자</td>
								<td><input type="text" name="name" value="${nick }"
									style="border: 0px;" readonly="readonly"></td>
							</tr>
							<tr>
								<td>사진</td>
