...
sb.append(" from (select seq, tt.* from (select rownum seq, t.* from (select * from movies order by salesrating desc) t) tt where seq >= ?) where rownum <= ?");
...
<body>
	...
	<div id="wrap">
		<input type="hidden" name="url" value="/view/henry/henry_salesrating.jsp" />
				...
				<div class="mainWrap">
					...
					<div class="main">
						...
						<ul class="listHeader">
							...
							<li class="listHeaderTitle"><a class="current" href="henry_salesrating.jsp">예매율순</a></li>
