...
sb.append(" from (select seq, tt.* from (select rownum seq, t.* from (select * from movies order by releasedate desc) t) tt where seq >= ?) where rownum <= ?");
...
<body>
	...
	<div id="wrap">
		<input type="hidden" name="url" value="/view/henry/henry_releasedate.jsp" />
