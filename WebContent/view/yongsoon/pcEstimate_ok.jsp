...
String sql = "insert into main_custom(mcno, cpu,vga,power,mb,ram1,ram2,hdd,ssd,price) values(s_main_custom.nextval,?,?,?,?,?,?,?,?,?)";
dao.insert(sql, cpu,vga,power,mb,ram1,ram2,hdd,ssd,price);
